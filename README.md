[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Flomocc%2Fon-demand-isr&env=APP_WEBHOOK_SECRET,APP_ID,APP_PK_PEM&envDescription=API%20keys%20needed%20to%20connect%20to%20the%20GitHub%20Application.&envLink=https%3A%2F%2Fgithub.com%2Flomocc%2Fon-demand-isr&demo-title=On-Demand%20ISR&demo-description=Demo%20of%20on-demand%20ISR%20in%20Next.js%2012.1%20using%20GitHub%20Issues.&demo-url=https%3A%2F%2Fon-demand-isr.vercel.app)
...
1. Create a new [GitHub App](https://github.com/settings/apps/new)
   ...
   1. Create a Webhook secret and add it to `.env.local` as `APP_WEBHOOK_SECRET`
   1. Give "Read Only" access to Issues
   1. Subscribe to "Issues" events
1. Add the App ID to `.env.local` as `APP_ID`
1. Generate a private key and add it to `.env.local` as `APP_PK_PEM`
